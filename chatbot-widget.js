...
function startConversation() {
    fetch('https://chatbot-for-elite-learning-academy.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-elite-learning-academy.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbyOZtpjYpVktPnBxbvvp_DF1ziLA4InsHK7VuZuTO6zvk6LAPnAykVLMWrnjxCbP_c/exec';
